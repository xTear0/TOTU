...
/*   Constructor                                                           */
/*-------------------------------------------------------------------------*/
#pragma region Inv_InventoryComponent.cpp_Constructor
...
void UInv_InventoryComponent::TryAddItem(UInv_ItemComponent* ItemComponent)
{
	...
	{
		// Add stacks to an item that already exists. Only update stack counts,
		// do not create a new item of this type.
